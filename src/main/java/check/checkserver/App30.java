...
public class App30 {
	public static void main(String[] args) throws ClassNotFoundException,
			SQLException {
		Logger log = Logger.getLogger(App30.class);
		String tp[] = { "TABLE" };
...
/*				ResultSet t = db.getColumns("", "AUDIT30TESTC", key.toString(),
						null);
				ResultSet t1 = db1.getColumns("", "AUDIT30TESTA",
						key.toString(), null);
				if (!CompareTable.compare(t, t1))
					log.info(key.toString() + "字段类型或字段类型不一致！");
				;
				t.close();
				t1.close();*/
